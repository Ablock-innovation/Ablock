...
1. Open Bash console
2. `git clone  https://github.com/Ablock-innovation/Ablock.git`
3. `cd uBlock`
...
[1] https://github.com/Ablock-innovation/Ablock/blob/c4d324362fdb95ff8ef20f0b18f42f0eec955433/tools/make-mv3.sh<br>
